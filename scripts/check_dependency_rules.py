...
ALLOWED = {
    ...
    "meridian-gpu-driver": {"meridian-platform-core"},
    "meridian-compute-driver": {"meridian-platform-core", "meridian-gpu-driver"},
    ...
    "meridian-graphics-driver": {"meridian-platform-core", "meridian-gpu-driver"},
